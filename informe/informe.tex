...
De esta manera, el estado interno del conteo no cambia, pero un observador no puede distinguir entre un voto real y uno dummy, protegiendo así al votante contra el análisis de tráfico temporal.
...
Si bien existen desafíos en términos de rendimiento y resistencia a la coerción, las soluciones propuestas y la rápida evolución de la criptografía homomórfica sugieren un futuro prometedor para la democracia digital descentralizada.
